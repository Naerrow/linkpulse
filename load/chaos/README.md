...
계획·예측표: [`docs/plans/0003-p3-2-fault-injection.md`](../../docs/plans/0003-p3-2-fault-injection.md) / 기록지: [`docs/postmortems/2026-07-XX-gameday-01.md`](../../docs/postmortems/2026-07-XX-gameday-01.md)
...
> **드릴 전용이다.** 평상시 배포 금지. 배포(주입)는 사람이 GameDay 절차에 따라 `deploy.yml`
> `workflow_dispatch`(`image_tag=chaos-healthz-v1`)로만 실행한다(가드레일 #1 — push·배포는 사람).
